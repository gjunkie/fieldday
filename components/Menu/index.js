  ...
  return (
    <div className={styles.menu}>
      ...
      >
        ...
        <ul>
          <li className={`${styles.button} ${styles.first}`}>
            <Link href="/work">
              <svg width="30" height="30" fill="none" viewBox="0 0 23 23">
          ...
          <li className={`${styles.button} ${styles.second}`} onClick={() => setAboutPanelIsOpen(!isAboutPanelOpen)}>
            <svg width="30" height="30" fill="none" viewBox="0 0 23 23">
